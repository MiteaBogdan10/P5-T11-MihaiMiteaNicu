        ...
        <td align="center">
            <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="panalty" HeaderText="Puncte Penalizare">
                    <ItemStyle Width="110px" />
                    </asp:BoundField>
                    <asp:BoundField DataField="detail" HeaderText="Detalii" />
                    <asp:BoundField DataField="entrydate" HeaderText="Data" />
                </Columns>
