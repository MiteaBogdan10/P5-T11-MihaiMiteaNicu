...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="tbl">
        ...
        <tr>
            <td align="center">
                <asp:Button ID="btntaken" runat="server" CssClass="btn" Text="LISTĂ ÎMPRUMUTATE" 
                    onclick="btntaken_Click" />
&nbsp;<asp:Button ID="btnreturn" runat="server" CssClass="btn" Text="LISTĂ RETURNATE" 
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                        BackColor="#f2f2f2" BorderColor="#aeaeae" BorderWidth="1px" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="issuedate" HeaderText="DatăÎmprumut" />
                                            <asp:BoundField DataField="days" HeaderText="Zile" />
                                        </Columns>
                                ...
                                <td>
                                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="returndate" HeaderText="DatăReturnare" />
                                        </Columns>
                                        <FooterStyle BackColor="Tan" />
                                        <HeaderStyle BackColor="#C1C1C1" Font-Bold="True" />
                                        <PagerStyle BackColor="PaleGoldenrod" ForeColor="DarkSlateBlue" 
