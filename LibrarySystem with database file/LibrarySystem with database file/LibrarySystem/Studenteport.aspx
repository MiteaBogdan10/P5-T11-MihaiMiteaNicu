            ...
            <table class="style1">
                <tr>
                    ...
                    <td class="style2">
                            ...
                            <asp:Button ID="Button11" runat="server" CssClass="btn" Text="Vizualizează" 
                    ...
                    <td class="lbl">
                            ...
                            <asp:Button ID="btnseach" runat="server" CssClass="btn" 
                                onclick="btnseach_Click" Text="Vizualizează" />
                    </td>
                </tr>
            </table>
        </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                                        ...
                                                        <Columns>
                                                            <asp:BoundField DataField="StudentName" HeaderText="NumeCititor" />
                                                            <asp:BoundField DataField="BranchName" HeaderText="Filială" />
                                                            ...
                                                            <asp:TemplateField HeaderText="Vizualizează">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lnkview" runat="server" CommandArgument='<%#Eval("sid") %>' 
                                                                        CssClass="lnk" Text="Vizualizează"></asp:LinkButton>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:Button ID="Button12" runat="server" CssClass="btn" 
                                                                    onclick="Button12_Click" Text="ÎNAPOI" Width="80px" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
